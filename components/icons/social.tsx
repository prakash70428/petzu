...
/**
 * Brand-accurate social glyphs — `lucide-react` doesn't ship wordmark icons,
 * so the footer previously stood in generic shapes (`AtSign` for X,
 * `Camera` for Instagram, `Users` for Facebook) that read as visibly wrong,
 * not just generic. These are minimal inline paths instead, `currentColor`
 * based so they still respect theme/hover color like any other icon.
 */
